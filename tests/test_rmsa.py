...
with open(f'C:/Users/Fonchi/Documents/IPD415/Proyecto/optical-rl-gym-main/examples/topologies/nsfnet_chen_eon_5-paths.h5', 'rb') as f:
...
init_env = gym.make('RMSCA-v0', **env_args)
